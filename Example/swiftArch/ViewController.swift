...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        btn3.setTitle("继承自BaseViewcontrollerDemo", for: UIControl.State.normal)
        btn3.onTap {
        ...
        btn6.setTitle("pagingViewcontrollerDemo手动计算行高的例子", for: UIControl.State.normal)
        btn6.onTap {
            [weak self] in
        ...
        btn7.setTitle("pagingCollectionViewcontrollerDemo的例子", for: UIControl.State.normal)
        btn7.onTap {
            [weak self] in
