...
//            }
    ...
    func composeAttrStr(text: String, extraText: String? = nil, atUser: PostUser? = nil) -> NSAttributedString {
        ...
        let specialAttributes = [NSAttributedString.Key.foregroundColor: UIColor.blue, NSAttributedString.Key.font: UIFont.systemFont(ofSize: 15)]
        let normalAttributes = [NSAttributedString.Key.foregroundColor: UIColor.black, NSAttributedString.Key.font: UIFont.systemFont(ofSize: 15)]
        let extraAttributes = [NSAttributedString.Key.foregroundColor: UIColor.purple, NSAttributedString.Key.font: UIFont.systemFont(ofSize: 15)]
        let iconFont = UIFont(name: "iconFont", size: 15)
        let iconAttributes = [NSAttributedString.Key.foregroundColor: UIColor.blue, NSAttributedString.Key.font: iconFont]
        ...
        for textPart in textParts {
            if textPart.isSpecial {
                ...
                if textPart.text.contains("\u{e60e}") {
                    let iconAttr = NSAttributedString(string: "\u{e618}", attributes: (iconAttributes as Any as! [NSAttributedString.Key: Any]))
