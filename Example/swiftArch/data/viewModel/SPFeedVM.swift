            ...
            if feed.textParts.count > 0 {
                for index in 0...feed.textParts.count-1 {
                    ...
                    if isMatch {
                        ...
                        let seeMoreStr = " 查看更多"
                        let seeMoreAttr = NSAttributedString(string: seeMoreStr, attributes: [NSAttributedString.Key.font: UIFont.systemFont(ofSize: 15), NSAttributedString.Key.foregroundColor: UIColor.blue])
