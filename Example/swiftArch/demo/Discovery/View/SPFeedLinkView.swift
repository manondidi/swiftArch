...
class SPFeedLinkView: UIView {
    ...
    lazy var backButton: UIButton = {
        ...
        backButton.setBackgroundImage(UIImage(named: "timeline_card_bottom_background_highlighted"), for: .highlighted)
        backButton.setBackgroundImage(UIImage(named: "timeline_card_bottom_background_normal"), for: UIControl.State.normal)
        backButton.onTap {
//            print("Tap")
        }
        return backButton
